...
export function GeneratePage(){
    ...
    return (
        <div className={styles.generate_container}>
            <h1 className={styles.short_info}>Сгенерируйте готовый csv-файл нажатием одной кнопки</h1>
            { loadingStatus === 'notLoaded' &&
                <button type="button" onClick={generateFile} className={styles.generate_button}>
