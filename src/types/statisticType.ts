...
export function isStatisticType(data: unknown): data is StatisticType {
  return (
    ...
    0 <= data.less_spent_at &&
    data.less_spent_at <= 364 &&
    "big_spent_at" in data &&
    typeof data.big_spent_at === "number" &&
    0 <= data.big_spent_at &&
    data.big_spent_at <= 364 &&
    "less_spent_value" in data &&
    typeof data.less_spent_value === "number" &&
    data.less_spent_value >= 0 &&
    "big_spent_value" in data &&
    typeof data.big_spent_value === "number" &&
    data.big_spent_value >= 0 &&
    "average_spend_galactic" in data &&
    typeof data.average_spend_galactic === "number" &&
    data.average_spend_galactic >= 0 &&
    "big_spent_civ" in data &&
    (data.big_spent_civ === "humans" ||
      data.big_spent_civ === "monsters" ||
      data.big_spent_civ === "blobs") &&
    "less_spent_civ" in data &&
    (data.less_spent_civ === "humans" ||
      data.less_spent_civ === "monsters" ||
      data.less_spent_civ === "blobs")
  );
}
